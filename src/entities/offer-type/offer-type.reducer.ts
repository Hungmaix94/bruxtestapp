...
import { IOfferType, defaultValue } from 'src/shared/model/offer-type.model';
...
export const getEntities = createAsyncThunk('offerType/fetch_entity_list', async ({ page, size, sort }: IQueryParams) => {
